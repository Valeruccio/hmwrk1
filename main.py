print("Реально огромная строка, позхволяющая посмотреть как работают переносы строки"+
      " устрашающий функционал")
...
if fingers < 20:
    print(name, ", cочувствую...")
else: print(name, ", ты читал и подписывал все требования безопасности!")
